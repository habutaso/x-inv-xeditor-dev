...
data TreeCommand a =
      Atomic (ListCommand a)
    | OpenRoot Int (TreeCommand a)
...
-- list_interp :: ListCommand t -> Tree t -> Maybe (Tree t)
...
-- tree_interp :: TreeCommand t -> Tree t -> Maybe (Tree] t) 
...
-- list_it :: ListCommand c -> ListCommand c
--            -> Bool -> [ListCommand c]
...
-- tree_it :: TreeCommand t -> TreeCommand t 
--            -> Bool -> [TreeCommand cmd t]
