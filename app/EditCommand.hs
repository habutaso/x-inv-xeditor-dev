...
insertL v (n+1) Nl = Nl -- should be an error
insertL v (n+1) (a :@ x) = a :@ insertL v n x
...
applyIth f (n+1) Nl = Nl   -- should be error
applyIth f (n+1) (a :@ x) = a :@ applyIth f n x
